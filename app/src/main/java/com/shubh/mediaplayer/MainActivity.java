...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int maxVol = audiomaneger.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
        int curVol = audiomaneger.getStreamVolume(AudioManager.STREAM_MUSIC);
